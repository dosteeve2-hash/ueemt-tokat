        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {BUREAU_MEMBERS.map(({ prenom, nom, role }) => (
              <div key={nom} className="bg-white rounded-2xl border-2 border-green-100 hover:border-green-400 p-6 text-center transition-all hover:shadow-md group">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-green-500 to-green-700 border-2 border-green-200 flex items-center justify-center text-white font-black text-2xl mx-auto mb-4 group-hover:scale-105 transition-transform">
                  {prenom[0]}{nom[0]}
                </div>
          ...
          <div className="relative border-l-2 border-green-200 pl-6 space-y-8">
            {[
              ...
              <div key={date} className="relative">
                <div className="absolute -left-8 w-3 h-3 bg-green-500 rounded-full border-2 border-white mt-1"></div>
